%% Description
% This code varies the values of immune activation (I_a here) over a  range and then 
% calculates new threshold values of viral antagonism (VC here) at each of those values. 
% This results in a bifurcation front (Figure 2b in the main text)
